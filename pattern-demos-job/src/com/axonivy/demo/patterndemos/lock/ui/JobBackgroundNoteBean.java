package com.axonivy.demo.patterndemos.lock.ui;

import java.time.Duration;

import org.apache.logging.log4j.message.MessageFormatMessage;

import com.axonivy.demo.patterndemos.lock.service.JobService;
...
public class JobBackgroundNoteBean {
	...
	public void unlockJob() {
		...
		if(!unlocked) {
			Ivy.log().info(new MessageFormatMessage("Job ''{0}'' could not be unlocked. Please check the logs.", jobName).getFormattedMessage());
		}
		locked = JobService.get().isLocked(jobName);
	}
